...
const st = StyleSheet.create({
  ...
  pageTitle: { flex: 1, fontFamily: Fonts.bold, fontSize: 24, letterSpacing: -0.84, lineHeight: 28, color: INK },
  markAll: { fontFamily: Fonts.semiBold, fontSize: 12, color: GOLD_INK },
  ...
  tabLabel: { fontFamily: Fonts.semiBold, fontSize: 15, letterSpacing: -0.3, color: INK_65 },
  count: { marginLeft: 'auto', paddingBottom: 11, fontFamily: Fonts.regular, fontSize: 11.5, color: INK_55 },
  ...
  groupTitle: { fontFamily: Fonts.semiBold, fontSize: 9.5, letterSpacing: 1.6, textTransform: 'uppercase', color: INK_45 },
  groupCount: { fontFamily: Fonts.medium, fontSize: 9.5, letterSpacing: 0.57, color: INK_45 },
  ...
  avatarTxt: { fontFamily: Fonts.bold, fontSize: 12.5, color: INK },
  body: { flex: 1, minWidth: 0, gap: 3 },
  headline: { flexDirection: 'row', alignItems: 'baseline', gap: 8 },
  title: { flex: 1, minWidth: 0, fontFamily: Fonts.semiBold, fontSize: 14.5, lineHeight: 19, letterSpacing: -0.22, color: INK },
  titleRead: { fontFamily: Fonts.medium, color: INK_72 },
  time: { fontFamily: Fonts.regular, fontSize: 10.5, color: INK_45 },
  text: { fontFamily: Fonts.regular, fontSize: 12.5, lineHeight: 17.5, color: INK_60 },
  cta: { marginTop: 5, fontFamily: Fonts.semiBold, fontSize: 11.5, color: GOLD_INK },
  ...
  emptyTitle: { fontFamily: Fonts.semiBold, fontSize: 15.5, color: INK, textAlign: 'center' },
  emptyText: { paddingTop: 20, fontFamily: Fonts.regular, fontSize: 13, lineHeight: 19, color: INK_50, textAlign: 'center' },
  fab: {
    position: 'absolute',
    right: SIDE,
    width: 56,
