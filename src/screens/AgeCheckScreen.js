...
const styles = StyleSheet.create({
  ...
  h1: { fontFamily: Fonts.semiBold, fontSize: 27, lineHeight: 31, letterSpacing: -0.8, color: Onboard.ink },
  sub: { fontFamily: Fonts.regular, fontSize: 14, lineHeight: 20, color: Onboard.ink2, marginTop: 10, marginBottom: 22 },
  strong: { fontFamily: Fonts.semiBold, color: Onboard.ink },
  option: {
  ...
  optionT: { fontFamily: Fonts.semiBold, fontSize: 16, color: Onboard.ink },
  optionD: { fontFamily: Fonts.regular, fontSize: 13, lineHeight: 18, color: Onboard.ink2, marginTop: 3 },
  optionDWaiting: { fontFamily: Fonts.medium, color: Onboard.goldInk },
  ...
  promiseT: { flex: 1, fontFamily: Fonts.semiBold, fontSize: 15, lineHeight: 20, color: Onboard.ink },
  ...
  smallT: { fontFamily: Fonts.semiBold, fontSize: 12.5, color: Onboard.ink },
  note: { fontFamily: Fonts.medium, fontSize: 13, lineHeight: 18, color: Onboard.ink2, marginTop: 14 },
  err: { fontFamily: Fonts.medium, fontSize: 13, lineHeight: 18, color: RED, marginTop: 14 },
  spacer: { flex: 1, minHeight: 24 },
  primary: { backgroundColor: Onboard.ink, borderRadius: 14, paddingVertical: 15, alignItems: 'center' },
  primaryT: { fontFamily: Fonts.semiBold, fontSize: 15, color: '#FFFFFF' },
  secondary: { borderRadius: 14, paddingVertical: 14, alignItems: 'center', borderWidth: 1, borderColor: 'rgba(10,10,10,0.18)', marginTop: 10 },
  secondaryT: { fontFamily: Fonts.semiBold, fontSize: 15, color: Onboard.ink },
  link: { alignItems: 'center', marginTop: 14, paddingVertical: 6 },
  linkT: { fontFamily: Fonts.semiBold, fontSize: 13.5, color: Onboard.ink2 },
});
