...
const s = StyleSheet.create({
  ...
  nt: { fontFamily: Fonts.semiBold, fontSize: 17, letterSpacing: -0.34, color: C.ink },
  nsc: { fontFamily: Fonts.regular, fontSize: 13, color: C.mut },

  scroll: { paddingHorizontal: 20, paddingBottom: 48 },
  hero: { paddingBottom: 22 },
  lede: { flexDirection: 'row', alignItems: 'baseline', flexWrap: 'wrap', gap: 9 },
  heroNum: { fontFamily: Fonts.extraBold, fontSize: 40, lineHeight: 42, letterSpacing: -1.6, color: C.ink },
  heroWord: { fontFamily: Fonts.regular, fontSize: 15, color: C.mut },
  heroNote: { fontFamily: Fonts.regular, fontSize: 13, color: C.mut, textAlign: 'right', marginTop: 9 },
  say: { fontFamily: Fonts.regular, fontSize: 16, lineHeight: 23, color: C.ink2, marginTop: 16 },
  ...
  aboutQ: { fontFamily: Fonts.bold, fontSize: 18, letterSpacing: -0.3, color: C.ink, marginBottom: 2 },
  aboutP: { fontFamily: Fonts.regular, fontSize: 15, lineHeight: 22, color: C.ink2 },
  ...
  fdn: { fontFamily: Fonts.semiBold, fontSize: 16, letterSpacing: -0.32, color: C.ink },
  ...
  tierTxt: { fontFamily: Fonts.medium, fontSize: 11, letterSpacing: 1.1, color: C.mut },
  ...
  pipTxt: { fontFamily: Fonts.regular, fontSize: 12.5, color: C.mut, marginLeft: 7 },
  ...
  wd: { fontFamily: Fonts.regular, fontSize: 13.5, color: C.mut },
  wdNow: { fontFamily: Fonts.semiBold, color: C.ink, fontSize: 14.5 },
  wv: { fontFamily: Fonts.semiBold, fontSize: 14.5, color: C.ink },
  ...
  wsub: { fontFamily: Fonts.regular, fontSize: 12, color: C.mut, marginTop: 8 },
  wsubMet: { fontFamily: Fonts.semiBold, color: C.goldInk },
  ...
  dayMin: { fontFamily: Fonts.semiBold, fontSize: 11.5, color: C.ink, marginBottom: 6 },
  dayMinNone: { fontFamily: Fonts.regular, color: C.faint },
  ...
  dayName: { fontFamily: Fonts.regular, fontSize: 11.5, color: C.mut, marginTop: 7 },
  dayNameNow: { fontFamily: Fonts.semiBold, color: C.ink },
  dayNote: { fontFamily: Fonts.regular, fontSize: 13.5, lineHeight: 19, color: C.mut, marginTop: 15 },
  dayNoteMet: { fontFamily: Fonts.semiBold, color: C.goldInk },
  secLab: {
    fontFamily: Fonts.extraBold, fontSize: 11.5, letterSpacing: 1.5, textTransform: 'uppercase',
    color: C.mut, marginTop: 18, paddingTop: 16, borderTopWidth: 1, borderTopColor: C.line, marginBottom: 12,
  },
  secNote: { fontFamily: Fonts.regular, fontSize: 13, lineHeight: 19, color: C.mut, marginTop: 14 },
  ...
  fwName: { fontFamily: Fonts.semiBold, fontSize: 14.5, color: C.ink },
  fwMeta: { fontFamily: Fonts.regular, fontSize: 12.5, color: C.mut, marginTop: 3 },
  ...
  bn: { flex: 1, fontFamily: Fonts.regular, fontSize: 14.5, color: C.mut },
  bnOn: { fontFamily: Fonts.semiBold, color: C.ink },
  br: { fontFamily: Fonts.regular, fontSize: 13, color: C.mut },
  ...
  youTxt: { fontFamily: Fonts.semiBold, fontSize: 11, letterSpacing: 1.1, color: '#7F5A0B' },
  ...
  legTxt: { fontFamily: Fonts.regular, fontSize: 12, color: C.mut },
  ...
  lzd: { width: 54, fontFamily: Fonts.regular, fontSize: 12.5, color: C.mut, paddingTop: 2 },
  lzt: { flex: 1, minWidth: 0 },
  lzTitle: { fontFamily: Fonts.semiBold, fontSize: 14.5, color: C.ink },
  lzSub: { fontFamily: Fonts.regular, fontSize: 12.5, color: C.mut, marginTop: 3 },
});
