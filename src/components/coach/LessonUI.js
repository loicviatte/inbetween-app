  ...
  return (
    <Pressable onPress={onPress} style={({ pressed }) => [st.pr, !first && st.itLine, dim && { opacity: 0.5 }, pressed && { backgroundColor: '#FBFAF7' }]}
      ...
      <View style={st.itBd}>
        ...
        {!!meta && <Text style={[st.itMeta, metaTone === 'gold' && { color: L.GOLD_INK, fontFamily: Fonts.semiBold }]} numberOfLines={1}>{meta}</Text>}
      </View>
      {right}
...
const st = StyleSheet.create({
  ...
  avT: { fontFamily: Fonts.bold, color: L.INK },
  ...
  hdT: { fontFamily: Fonts.semiBold, fontSize: 17, letterSpacing: -0.34, color: L.INK },
  hdS: { fontFamily: Fonts.regular, fontSize: 11.5, color: 'rgba(10,10,10,0.65)', marginTop: 1 },
  ...
  heroPcN: { fontFamily: Fonts.extraBold, fontSize: 52, letterSpacing: -3.1, lineHeight: 46, color: L.GOLD, fontVariant: ['tabular-nums'] },
  heroPcU: { fontFamily: Fonts.bold, fontSize: 20, lineHeight: 22, color: 'rgba(232,181,48,0.75)', paddingLeft: 2, marginTop: 1 },
  heroNm: { flex: 1, minWidth: 0, paddingBottom: 1 },
  heroT: { fontFamily: Fonts.bold, fontSize: 20, letterSpacing: -0.7, lineHeight: 23, color: '#FFFFFF' },
  heroLb: { fontFamily: Fonts.semiBold, fontSize: 9, letterSpacing: 1.35, textTransform: 'uppercase', color: 'rgba(255,255,255,0.7)', marginTop: 5 },
  heroP: { fontFamily: Fonts.regular, fontSize: 13.5, lineHeight: 20, color: 'rgba(255,255,255,0.8)' },
  heroStrong: { fontFamily: Fonts.semiBold, color: '#FFFFFF' },
  heroAlert: { fontFamily: Fonts.semiBold, color: '#F0A08C' },
  ...
  heroFigN: { fontFamily: Fonts.bold, fontSize: 18, letterSpacing: -0.7, lineHeight: 20, color: '#FFFFFF', fontVariant: ['tabular-nums'] },
  heroFigU: { fontFamily: Fonts.regular, fontSize: 11, color: 'rgba(255,255,255,0.62)' },
  heroFigL: { fontFamily: Fonts.semiBold, fontSize: 8.5, letterSpacing: 0.95, textTransform: 'uppercase', color: 'rgba(255,255,255,0.7)', marginTop: 5 },

  sh: { flexDirection: 'row', alignItems: 'baseline', gap: 10, paddingTop: 19, paddingBottom: 9, paddingHorizontal: 2 },
  shT: { fontFamily: Fonts.semiBold, fontSize: 9.5, letterSpacing: 1.6, textTransform: 'uppercase', color: L.INK_62 },
  shR: { flex: 1, textAlign: 'right', fontFamily: Fonts.regular, fontSize: 11, color: L.INK_62 },
  ...
  qh: {
    ...
    fontFamily: Fonts.bold, fontSize: 9, letterSpacing: 1.35, textTransform: 'uppercase', color: L.INK_62,
  },
  ...
  itT: { fontFamily: Fonts.semiBold, fontSize: 14, letterSpacing: -0.25, lineHeight: 18, color: L.INK },
  itTDone: { color: 'rgba(10,10,10,0.45)', textDecorationLine: 'line-through' },
  itMetaRow: { flexDirection: 'row', alignItems: 'center', gap: 6 },
  itMeta: { flexShrink: 1, fontFamily: Fonts.regular, fontSize: 10.5, color: L.INK_62 },
  ...
  chipT: { fontFamily: Fonts.bold, fontSize: 9, letterSpacing: 0.8, textTransform: 'uppercase', color: L.GOLD_INK },
  qm: { width: 17, fontFamily: Fonts.bold, fontSize: 24, lineHeight: 24, color: L.GOLD },
  ...
  vbT: { fontFamily: Fonts.semiBold, fontSize: 11, color: 'rgba(10,10,10,0.68)' },
  ...
  tlLabel: { fontFamily: Fonts.semiBold, fontSize: 9.5, letterSpacing: 1.2, textTransform: 'uppercase', color: L.INK_62 },
  tlTitle: { fontFamily: Fonts.semiBold, fontSize: 14, letterSpacing: -0.25, lineHeight: 18, color: L.INK },
  tlTitleLesson: { fontFamily: Fonts.bold, fontSize: 15, letterSpacing: -0.4, lineHeight: 19, color: L.INK },
  tlDetail: { fontFamily: Fonts.regular, fontSize: 11, color: L.INK_62 },

  pr: { flexDirection: 'row', alignItems: 'center', gap: 12, paddingVertical: 12, paddingHorizontal: 14 },
  prName: { fontFamily: Fonts.semiBold, fontSize: 14.5, letterSpacing: -0.3, color: L.INK },
  prPct: { fontFamily: Fonts.bold, fontSize: 17, letterSpacing: -0.7, color: L.INK, fontVariant: ['tabular-nums'] },
  prPctU: { fontFamily: Fonts.semiBold, fontSize: 11, color: 'rgba(10,10,10,0.45)' },
  ...
  tabsR: { marginLeft: 'auto', paddingBottom: 11, fontFamily: Fonts.regular, fontSize: 11.5, color: L.INK_62 },
  ...
  liveTime: { fontFamily: Fonts.bold, fontSize: 24, letterSpacing: -1, color: '#FFFFFF', fontVariant: ['tabular-nums'] },
  liveLabel: { fontFamily: Fonts.semiBold, fontSize: 9, letterSpacing: 1.3, textTransform: 'uppercase', color: 'rgba(255,255,255,0.62)' },
  liveSource: { fontFamily: Fonts.regular, fontSize: 11, color: 'rgba(255,255,255,0.8)', marginTop: 2 },
  ...
  liveEndT: { fontFamily: Fonts.bold, fontSize: 14, color: '#FFFFFF' },
  ...
  popTitle: { fontFamily: Fonts.bold, fontSize: 20, letterSpacing: -0.6, lineHeight: 24, color: L.INK },
  popBody: { fontFamily: Fonts.regular, fontSize: 13.5, lineHeight: 20, color: 'rgba(10,10,10,0.7)' },
  popStrong: { fontFamily: Fonts.semiBold, color: L.INK },
  ...
  popBtnT: { fontFamily: Fonts.bold, fontSize: 15, letterSpacing: -0.3, color: L.INK },
  ...
  vpT: { fontFamily: Fonts.semiBold, fontSize: 11.5 },

  empty: { fontFamily: Fonts.regular, fontSize: 13, lineHeight: 19, color: L.INK_62, paddingVertical: 12, paddingHorizontal: 2 },
});
