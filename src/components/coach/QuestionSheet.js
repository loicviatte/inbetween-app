...
const qs = StyleSheet.create({
  ...
  qT: { fontFamily: Fonts.semiBold, fontSize: 16, letterSpacing: -0.3, lineHeight: 21, color: '#FFFFFF' },
  qS: { fontFamily: Fonts.regular, fontSize: 11, color: 'rgba(255,255,255,0.7)' },
  ...
  tabT: { fontFamily: Fonts.semiBold, fontSize: 14, letterSpacing: -0.28, color: 'rgba(10,10,10,0.6)' },

  pane: { paddingHorizontal: Spacing.side, paddingTop: 14, gap: 9 },
  loading: { paddingVertical: 34, alignItems: 'center' },
  plain: { paddingHorizontal: Spacing.side, paddingTop: 16, fontFamily: Fonts.regular, fontSize: 13, lineHeight: 19, color: L.INK_62 },
  ...
  blkName: { flex: 1, minWidth: 0, fontFamily: Fonts.semiBold, fontSize: 14.5, letterSpacing: -0.26, color: L.INK },
  blkTier: { fontFamily: Fonts.bold, fontSize: 10, letterSpacing: 0.9, textTransform: 'uppercase', color: L.GOLD_INK },
  blkP: { fontFamily: Fonts.regular, fontSize: 12.5, lineHeight: 18, color: 'rgba(10,10,10,0.68)' },
  mini: { fontFamily: Fonts.regular, fontSize: 11.5, color: L.INK_62 },
  miniB: { fontFamily: Fonts.semiBold, color: L.INK },
  ...
  dtN: { fontFamily: Fonts.bold, fontSize: 15, letterSpacing: -0.6, lineHeight: 16, color: L.NAVY },
  dtM: { fontFamily: Fonts.bold, fontSize: 8, letterSpacing: 0.8, textTransform: 'uppercase', color: L.INK_62 },
  lrowT: { fontFamily: Fonts.semiBold, fontSize: 14, letterSpacing: -0.25, color: L.INK },
  lrowS: { fontFamily: Fonts.regular, fontSize: 10.5, color: L.INK_62 },
  ...
  hrLabel: { fontFamily: Fonts.semiBold, fontSize: 9.5, letterSpacing: 1.2, textTransform: 'uppercase', color: L.INK_62 },
  hrT: { fontFamily: Fonts.semiBold, fontSize: 13.5, letterSpacing: -0.25, lineHeight: 18, color: L.INK },
  hrTSet: { fontFamily: Fonts.bold, fontSize: 14, letterSpacing: -0.35, lineHeight: 18, color: L.INK },
  hrS: { fontFamily: Fonts.regular, fontSize: 11, color: L.INK_62 },
  ...
  input: {
    ...
    fontFamily: Fonts.regular, fontSize: 14.5, lineHeight: 19, color: L.INK,
  },
  ...
  doneT: { fontFamily: Fonts.bold, fontSize: 16.5, letterSpacing: -0.3, color: L.INK },
  alt: { paddingTop: 12, paddingBottom: 2, alignItems: 'center' },
  altT: { fontFamily: Fonts.semiBold, fontSize: 13, color: L.INK_62 },
  ...
  lbarT: { fontFamily: Fonts.bold, fontSize: 17, letterSpacing: -0.5, color: L.INK },
  lbarS: { fontFamily: Fonts.regular, fontSize: 11, color: L.INK_62, marginTop: 2 },
  ...
  lsecH: { fontFamily: Fonts.semiBold, fontSize: 9.5, letterSpacing: 1.6, textTransform: 'uppercase', color: L.INK_62 },
  lsecP: { fontFamily: Fonts.regular, fontSize: 14, lineHeight: 21, color: L.INK },
  ...
  fp2T: { flex: 1, minWidth: 0, fontFamily: Fonts.regular, fontSize: 13.5, color: L.INK },
  fp2Tier: { fontFamily: Fonts.semiBold, fontSize: 11, color: L.INK_62 },
});
