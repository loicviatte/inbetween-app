...
const st = StyleSheet.create({
  ...
  title: { fontFamily: Fonts.bold, fontSize: 15.5, color: INK, letterSpacing: -0.16 },
  sub: { fontFamily: Fonts.regular, fontSize: 13, color: INK_2, marginTop: 2 },
  dot: { width: 8, height: 8, borderRadius: 4, backgroundColor: '#2E9D5B' },
  body: { fontFamily: Fonts.regular, fontSize: 14, lineHeight: 20, color: INK_2, marginTop: 14 },

  kicker: { fontFamily: Fonts.bold, fontSize: 11.5, letterSpacing: 1.1, textTransform: 'uppercase', color: GOLD_INK, textAlign: 'center' },
  code: { fontFamily: Fonts.bold, fontSize: 30, letterSpacing: 3, color: INK, textAlign: 'center', marginTop: 12 },
  codeOff: { color: 'rgba(20,19,17,0.25)', textDecorationLine: 'line-through' },
  expiry: { fontFamily: Fonts.medium, fontSize: 13, color: INK_2, textAlign: 'center', marginTop: 6 },
  ...
  stepNumT: { fontFamily: Fonts.bold, fontSize: 11.5, color: '#FFFFFF' },
  stepT: { flex: 1, fontFamily: Fonts.regular, fontSize: 14, lineHeight: 20, color: INK },
  waiting: { flexDirection: 'row', alignItems: 'center', gap: 8, marginTop: 2 },
  waitingT: { fontFamily: Fonts.medium, fontSize: 13, color: GOLD_INK },

  err: { fontFamily: Fonts.medium, fontSize: 13, lineHeight: 18, color: RED, marginTop: 12 },
  ...
  btnT: { fontFamily: Fonts.bold, fontSize: 15, color: '#FFFFFF' },
  textBtn: { paddingVertical: 8 },
  textBtnT: { fontFamily: Fonts.bold, fontSize: 14, color: INK },
});
