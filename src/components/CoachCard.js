...
const s = StyleSheet.create({
  ...
  cavT: { fontFamily: Fonts.extraBold, fontSize: 14, color: T.ink },
  cwho: { flex: 1, minWidth: 0, gap: 2 },
  cname: { fontFamily: Fonts.semiBold, fontSize: 18, letterSpacing: -0.36, color: D.on },
  ccred: { fontFamily: Fonts.regular, fontSize: 12, color: D.on2 },
  cess: { fontFamily: Fonts.medium, fontSize: 15.5, lineHeight: 22, letterSpacing: -0.16, color: T.gold },
  ...
  cwordT: { fontFamily: Fonts.regular, fontSize: 11.5, color: D.on },
  cblock: { gap: 5, paddingTop: 12, borderTopWidth: 1, borderTopColor: D.line },
  cnum: { fontFamily: Fonts.medium, fontSize: 9.5, letterSpacing: 1.33, textTransform: 'uppercase', color: 'rgba(255,255,255,0.62)' },
  cbody: { fontFamily: Fonts.regular, fontSize: 13.5, lineHeight: 20, color: D.on },
  ...
  cchipT: { fontFamily: Fonts.regular, fontSize: 11.5, color: D.on },
  cbars: { gap: 7, paddingTop: 3 },
  cbar: { flexDirection: 'row', alignItems: 'center', gap: 9 },
  cbarK: { width: 82, fontFamily: Fonts.regular, fontSize: 11.5, color: 'rgba(255,255,255,0.78)' },
  ...
  cbarV: { width: 30, textAlign: 'right', fontFamily: Fonts.medium, fontSize: 11.5, color: D.on },
  ctrack: { gap: 9, paddingTop: 3 },
  ctrow: { flexDirection: 'row', alignItems: 'center', gap: 9 },
  ctrackT: { fontFamily: Fonts.regular, fontSize: 12.5, color: D.on3 },
  ctrackOn: { color: D.on, fontFamily: Fonts.medium },
  tierHead: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
  tierT: { fontFamily: Fonts.medium, fontSize: 13, color: D.on2 },
  ...
  tierCount: { fontFamily: Fonts.medium, fontSize: 11.5, color: D.on3, minWidth: 44, textAlign: 'right' },
  subLab: { fontFamily: Fonts.medium, fontSize: 11.5, color: D.on2, paddingTop: 4 },
  subLabGap: { paddingTop: 10 },
  obsNote: { fontFamily: Fonts.regular, fontSize: 12, lineHeight: 17, color: D.on2, paddingTop: 2 },
  ...
  cbtnT: { fontFamily: Fonts.semiBold, fontSize: 13.5, color: T.ink },
  cby: { fontFamily: Fonts.regular, fontSize: 10, letterSpacing: 1.4, color: D.on3 },
});
