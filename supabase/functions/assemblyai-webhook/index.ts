  ...
  try {
    const data = await callAnthropic(
      ...
      },
      {
        ...
        context: 'translate',
        // Translation happens per audio chunk before the recording is
        // finalized into a class_input, so we don't have an id to attach
        // yet. Cost lands in the unattributed bucket.
        class_input_id: null,
        user_id: null,
